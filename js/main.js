...
function animatecounters() {
    ...
    /*==============================================================*/
    jQuery({ ValuerHbcO: 0 }).delay(0).animate({ ValuerHbcO: 400 },
    {
        duration: 2000,
        easing: "swing",
        step: function () {
    ...
    jQuery({ ValuerHbcO: 0 }).delay(0).animate({ ValuerHbcO: 85344 },
    {
        duration: 3500,
        easing: "swing",
        step: function () {
	...
	//$("#anim-number-client").html('58497');
	
    jQuery({ ValuerHbcO: 0 }).delay(0).animate({ ValuerHbcO: 495 },
    {
        duration: 2000,
        easing: "swing",
        step: function () {
    ...
    jQuery({ ValuerHbcO: 0 }).delay(0).animate({ ValuerHbcO: 650 },
    {
        duration: 2000,
        easing: "swing",
        step: function () {
